...
module.exports.makeJwtAccessToken = (userId) => {
  jwt.sign({ user: userId }, jwtAccessKey, { expiresIn: (60 * +jwtAccessExpiredMinutes) });
};

module.exports.makeJwtRefreshToken = (userId) => jwt.sign({ user_refresh: userId, refresh: 'refresh' }, jwtRefreshKey, { expiresIn: (30 * 60 * +jwtRefreshExpiredDays) });
